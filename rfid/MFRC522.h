...
void Write_MFRC522(char, char);
char Read_MFRC522(char);
void SetBitMask(char, char);
void ClearBitMask(char,char);
void AntennaOn();
void AntennaOff();
void MFRC522_Reset();
void MFRC522_Init();
char MFRC522_Request(char, char*);
char MFRC522_ToCard(char, char*, char, char*, uint8_t*);
char MFRC522_Anticoll(char*);
void CalulateCRC(char*, char, char*);
